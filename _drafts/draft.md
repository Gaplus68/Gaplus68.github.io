...
Io sono andato a recuperare uscita la prima bozza della specifica OCP (versione 0.7.0), più di centto pagine
...
Il documento porta esempi sono di carichi di lavoro LLM reali:
- Parameter Store
- KV Cache
...
Nei prossimi post spero di sendere nei dettagli ed anticipare qualche tema utile per anticipare futuri sviluppi.
